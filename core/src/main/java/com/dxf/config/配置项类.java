...
public class 配置项类 {
    ...
    static {
        ...
        技能栏配置列表.put("通用", Arrays.asList(
                ...
                new 技能信息类("H", 按键枚举.H.getStrCode(), 15, 技能信息类.技能类型枚举.攻击, 0, 100, 20),
                ...
                new 技能信息类("Y", 按键枚举.Y.getStrCode(), 100, 技能信息类.技能类型枚举.攻击, 0, 100, 1),
                ...
                new 技能信息类("UDS", "up|down|space", 5, 技能信息类.技能类型枚举.BUFF),
                new 技能信息类("UDS", "left|down|right|space", 5, 技能信息类.技能类型枚举.BUFF)
