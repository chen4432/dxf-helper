...
public class 配置项类 {
    ...
    static {
        ...
        技能栏配置列表.put("剑圣花弄影", Arrays.asList(
                new 技能信息类("普通攻击", 按键枚举.X.getStrCode(), 5, 0, 0, 0, 1, 3),
        ...
        技能栏配置列表.put("修罗花弄影", Arrays.asList(
                new 技能信息类("普通攻击", 按键枚举.X.getStrCode(), 2, 0,0, 888, 1, 3),

                new 技能信息类("波动爆发", 按键枚举.A.getStrCode(), 8, 0,0, 0, 1, 5),
                new 技能信息类("地裂波动剑", 按键枚举.S.getStrCode(), 3, 0,0, 0, 10, 10),
                new 技能信息类("三段斩", 按键枚举.D.getStrCode(), 6, 0,0, 0, 100, 100),
                new 技能信息类("邪光斩", 按键枚举.F.getStrCode(), 10, 0,0, 1000, 20, 20),
                new 技能信息类("无双波", 按键枚举.G.getStrCode(), 15, 0,0, 0, 100, 100),
                new 技能信息类("天雷波动剑", 按键枚举.H.getStrCode(), 38, 0,0, 0, 100, 30),

                new 技能信息类("冰刃波动剑", 按键枚举.Q.getStrCode(), 7, 0,0, 0, 1, 5),
                new 技能信息类("爆炎波动剑", 按键枚举.W.getStrCode(), 15, 0,0, 0, 5, 5),
                new 技能信息类("极冰列波剑", 按键枚举.E.getStrCode(), 14, 0,0, 0, 50, 4),
                new 技能信息类("极炎列波剑", 按键枚举.R.getStrCode(), 34, 0,0, 0, 50, 3),
                new 技能信息类("波动慧眼", 按键枚举.T.getStrCode(), 57, 0,0, 0, 100, 2),
                new 技能信息类("雷神降世", 按键枚举.Y.getStrCode(), 180, 0,0, 0, 101, 1),
        ...
        技能栏配置列表.put("魔神花弄影", Arrays.asList(
                new 技能信息类("X", 按键枚举.X.getStrCode(), 2, 0,0, 1000, 1, 10),

                new 技能信息类("波动爆发", 按键枚举.A.getStrCode(), 8, 0,0, 0, 1, 5),
                new 技能信息类("地裂波动剑", 按键枚举.S.getStrCode(), 3, 0,0, 0, 10, 10),
                new 技能信息类("三段斩", 按键枚举.D.getStrCode(), 6, 0,0, 0, 100, 100),
                new 技能信息类("邪光斩", 按键枚举.F.getStrCode(), 10, 0,0, 0, 20, 20),
                new 技能信息类("无双波", 按键枚举.G.getStrCode(), 15, 0,0, 0, 100, 100),
                new 技能信息类("天雷波动剑", 按键枚举.H.getStrCode(), 38, 0,0, 0, 100, 30),
