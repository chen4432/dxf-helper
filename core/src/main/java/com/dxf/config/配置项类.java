...
public class 配置项类 {
    ...
    static {
        ...
        技能栏配置列表.put("通用", Arrays.asList(
                new 技能信息类("X", 按键枚举.X.getStrCode(), 2, 技能信息类.技能类型枚举.攻击, 1000, 11, 21),

                new 技能信息类("A", 按键枚举.A.getStrCode(), 5, 技能信息类.技能类型枚举.攻击, 0, 10, 20),
                new 技能信息类("S", 按键枚举.S.getStrCode(), 5, 技能信息类.技能类型枚举.攻击, 0, 10, 20),
                new 技能信息类("D", 按键枚举.D.getStrCode(), 10, 技能信息类.技能类型枚举.攻击, 0, 10, 20),
                new 技能信息类("F", 按键枚举.F.getStrCode(), 10, 技能信息类.技能类型枚举.攻击, 0, 10, 20),
                new 技能信息类("G", 按键枚举.G.getStrCode(), 20, 技能信息类.技能类型枚举.攻击, 0, 10, 20),
                new 技能信息类("H", 按键枚举.H.getStrCode(), 20, 技能信息类.技能类型枚举.攻击, 0, 100, 20),

                new 技能信息类("Q", 按键枚举.Q.getStrCode(), 40, 技能信息类.技能类型枚举.攻击, 0, 20, 6),
                new 技能信息类("W", 按键枚举.W.getStrCode(), 40, 技能信息类.技能类型枚举.攻击, 0, 20, 5),
                new 技能信息类("E", 按键枚举.E.getStrCode(), 40, 技能信息类.技能类型枚举.攻击, 0, 20, 4),
